...
const FiqhProgram = () => {
  const features = [
    {
      icon: BookText,
      title: "Practical Rulings",
      description: "Learning Islamic jurisprudence for everyday life",
    },
    {
      icon: Users,
    ...
    },
    {
      ...
      description: "Comprehensive curriculum covering essential rulings",
    },
    {
      icon: Award,
      title: "Certification",
  ...
  const steps = [
    {
      number: "01",
      title: "Purification",
      description: "Learning the rulings of purification and cleanliness",
    },
    {
      number: "02",
      title: "Prayer",
      description: "Understanding the pillars and conditions of Salah",
    },
    {
      number: "03",
      title: "Fasting & Zakat",
      description: "Rulings related to fasting and obligatory charity",
    },
    {
      number: "04",
      title: "Daily Life Fiqh",
      description: "Practical rulings for everyday situations",
    },
  ];
      ...
      <section className="py-20 bg-gradient-hero">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-up">
            ...
            >
              Rawdatul Atfaal Fiqh Program
            </h1>
            <p
              className="text-xl text-muted-foreground max-w-2xl mx-auto animate-fade-up"
              style={{ animationDelay: "0.6s" }}
            >
              Learning Islamic jurisprudence and practical rulings for everyday
              worship and interactions based on authentic sources. We teach Fiqh
              based on the understanding of the Salaf.
            </p>
            <div
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-foreground">
              Why Choose Our Fiqh Program?
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              We teach practical Islamic rulings based on authentic sources,
              making them easy to understand and apply
            </p>
          </div>
      ...
      <section className="py-20 bg-muted">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              A structured approach to understanding Islamic jurisprudence
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground">
                We teach Fiqh based on the Quran, Sunnah, and the understanding
                of the Salaf. Our approach makes complex rulings easy to
                understand and apply in daily life.
              </p>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Every ruling backed by authentic proofs
                    </p>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-primary-foreground">
              Start Learning Islamic Jurisprudence
            </h2>
            <p className="text-xl text-primary-foreground/90 max-w-2xl mx-auto">
              Enroll in our Fiqh program to learn practical Islamic rulings that
              will guide your child's everyday worship and interactions.
            </p>
