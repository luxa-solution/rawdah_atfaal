...
const TajwidProgram = () => {
  const features = [
    {
      icon: AudioLines,
      title: "Proper Recitation",
      description: "Learning the rules of beautiful Quranic recitation",
    },
    {
      icon: Users,
    ...
    },
    {
      ...
      description: "Comprehensive curriculum covering all Tajwid rules",
    },
    {
      icon: Award,
      title: "Certification",
  ...
  const steps = [
    {
      number: "01",
      title: "Makharij",
      description: "Learning the articulation points of Arabic letters",
    },
    {
      number: "02",
      title: "Basic Rules",
      description: "Understanding essential Tajwid rules and application",
    },
    {
      number: "03",
      title: "Advanced Rules",
      description: "Mastering complex rules and beautification",
    },
    {
      number: "04",
      title: "Perfect Recitation",
      description: "Applying all rules for beautiful Quran recitation",
    },
  ];
      ...
      <section className="py-20 bg-gradient-hero">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-up">
            ...
            >
              Rawdatul Atfaal Tajwid Program
            </h1>
            <p
              className="text-xl text-muted-foreground max-w-2xl mx-auto animate-fade-up"
              style={{ animationDelay: "0.6s" }}
            >
              Mastering the art of Quranic recitation with proper pronunciation,
              articulation points, and beautification rules. We teach Tajwid
              according to authentic methods and traditional transmission.
            </p>
            <div
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-foreground">
              Why Choose Our Tajwid Program?
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              We provide comprehensive Tajwid education based on authentic
              methods, ensuring beautiful and correct Quranic recitation
            </p>
          </div>
      ...
      <section className="py-20 bg-muted">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              A structured approach to mastering Tajwid rules
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground">
                We teach Tajwid using proven methods that have been transmitted
                through generations. Our approach ensures students learn proper
                articulation and beautiful recitation.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Progressive curriculum from basic to advanced rules
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Immediate practice and correction in every lesson
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Learn from qualified teachers with proper certification
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="w-full h-96 bg-gradient-warm rounded-3xl p-8 shadow-card">
                <div className="h-full flex flex-col justify-center space-y-6">
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground">
                      Comprehensive Tajwid curriculum
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground">
                      Authentic Tajwid texts and resources
                    </p>
                    <p className="text-muted-foreground">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-primary-foreground/90 max-w-2xl mx-auto">
              Enroll in our Tajwid program to help your child recite the Quran
              beautifully and correctly with proper rules.
            </p>
