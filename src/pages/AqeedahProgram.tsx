...
const AqeedahProgram = () => {
  const features = [
    {
      icon: Heart,
      title: "Authentic Creed",
      description: "Learning Islamic belief based on Quran and Sunnah",
    },
    {
      icon: Users,
    ...
    },
    {
      ...
      description: "Comprehensive curriculum for understanding Tawheed",
    },
    {
      icon: Award,
      title: "Certification",
  ...
  const steps = [
    {
      number: "01",
      title: "Foundation",
      description: "Introduction to Islamic belief and the pillars of faith",
    },
    {
      number: "02",
      title: "Understanding Tawheed",
      description: "Learning the oneness of Allah in worship and belief",
    },
    {
      number: "03",
      title: "Names & Attributes",
      description: "Study of Allah's beautiful names and attributes",
    },
    {
      number: "04",
      title: "Advanced Topics",
      description: "Understanding matters of belief in depth",
    },
  ];
      ...
      <section className="py-20 bg-gradient-hero">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-up">
            ...
            >
              Rawdatul Atfaal Aqeedah Program
            </h1>
            <p
              className="text-xl text-muted-foreground max-w-2xl mx-auto animate-fade-up"
              style={{ animationDelay: "0.6s" }}
            >
              Building a strong foundation in Islamic belief and creed based on
              the Qur'an and Sunnah as understood by the righteous predecessors.
              We teach authentic Islamic creed free from innovations.
            </p>
            <div
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-foreground">
              Why Choose Our Aqeedah Program?
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              We teach authentic Islamic creed based on the Quran and Sunnah, as
              understood by the Salaf us-Salih (righteous predecessors)
            </p>
          </div>
      ...
      <section className="py-20 bg-muted">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              A structured approach to understanding Islamic belief
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground">
                We teach authentic Islamic creed based on the understanding of
                the Salaf us-Salih. Our approach emphasizes correct belief in
                Allah, His Names and Attributes, and all pillars of faith.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Every concept taught with proofs from Quran and Sunnah
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Covering all essential aspects of Islamic belief
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="w-full h-96 bg-gradient-warm rounded-3xl p-8 shadow-card">
                <div className="h-full flex flex-col justify-center space-y-6">
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground">
                      Comprehensive Aqeedah curriculum
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground">
                      Authentic Islamic texts and resources
                    </p>
                    <p className="text-muted-foreground">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-primary-foreground">
              Build Your Child's Islamic Foundation
            </h2>
            <p className="text-xl text-primary-foreground/90 max-w-2xl mx-auto">
              Enroll in our Aqeedah program to ensure your child learns
              authentic Islamic belief based on the Quran and Sunnah.
            </p>
